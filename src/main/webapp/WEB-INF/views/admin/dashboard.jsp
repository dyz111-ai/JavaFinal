    ...
    <div class="container mx-auto px-4 py-8">
        <div class="dashboard-container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- 图书管理 -->
                <a href="<%= request.getContextPath() %>/admin/books.jsp" class="dashboard-card border-l-4 border-blue-500 hover:bg-blue-50/60">
                    <h3 class="card-title">图书管理</h3>
                    <p class="card-description">新增、查询、修改和删除图书信息。</p>
                </a>

                <!-- 公告发布 -->
                <a href="<%= request.getContextPath() %>/admin/announcements.jsp" class="dashboard-card border-l-4 border-rose-500 hover:bg-rose-50/60">
